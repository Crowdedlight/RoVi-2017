...
int main(int argc, char* argv[])
{
    ...
    //todo debug
//    cv::Mat debug, debug2, debug_mask;
//    debug = cv::imread("../debug_image_points2.png", CV_LOAD_IMAGE_COLOR);
//
//    applyHSVSegmentation(debug, debug2, debug_mask, cv::Scalar(118,255,255), cv::Scalar(137,255,255), cv::MORPH_CLOSE, cv::Size(25,25));
//    findBlobDetecting(debug_mask);
    ...
    //save processing time in file
    string time_out_file = "../Outfiles/processing_time.txt";

    ofstream time_out;
    time_out.open(time_out_file);
    time_out.clear();
